...
assert.equal(website.domain, (await readFile('/publication/CNAME', 'utf8')).trim(), 'Pages domain differs from the published CNAME.');
...
for (const forbidden of ['mobile', 'tests', '.mprlab', '.env', 'package.json', 'node_modules']) {
